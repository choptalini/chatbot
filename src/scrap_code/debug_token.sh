...
# WhatsApp Access Token Debug Script
...
if [ "$APP_TOKEN" = "YOUR_APP_TOKEN_HERE" ]; then
...
curl -X GET \
  "https://graph.facebook.com/debug_token?input_token=$ACCESS_TOKEN&access_token=$APP_TOKEN"
